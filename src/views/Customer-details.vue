<template>
    ...
    <div class="overflow-x-auto">
      ...
      >
        ...
        <tbody>
          ...
          >
            <td class="p-4 text-gray-700 whitespace-nowrap">{{ contract.start_date }}</td>
            <td class="p-4 text-gray-700 whitespace-nowrap">{{ contract.expire_date }}</td>
            <td class="p-4 text-gray-700 whitespace-nowrap">{{ contract.payment }}</td>
           ...
           <div class="flex items-center">
            <button
              ...
              <svg
                  ...
                  <button @click="confirmDelete(contract.id)" class="p-2 rounded-full text-white transition cursor-pointer">
  ...
  <!-- Pagination Controls -->
  <div v-if="contracts.length>10" class="flex justify-between items-center mt-4">
      <button
  ...
  <div class="relative p-4 w-full max-w-md">
    <div class="relative bg-white rounded-lg shadow-lg dark:bg-gray-700">
      <!-- Close Button -->
      <button @click="deleteModalOpen = false" type="button" class="absolute flex justify-center items-center top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 dark:hover:bg-gray-600 dark:hover:text-white">
...
const deleteContracts = async () => {
      ...
      try {
        await axios.delete(
          `${API_URL}/contracts/${deleteId.value}`
        );
