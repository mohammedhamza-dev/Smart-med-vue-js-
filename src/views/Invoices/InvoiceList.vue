<template>
  ...
  <div class="" v-else>
    ...
    <div
      v-else
      class="p-4 2xl:max-w-[1800px] max-w-[1300px] mt-[100px] mx-auto"
    >
      ...
      <div v-else class="">
        ...
        >
          <section
            v-for="(invoices, index) in invoices"
            :key="invoices.id"
                    ...
                    <div class="flex-grow truncate">
                      ...
                      >
                        ...
                        <div class="flex flex-col">
                          ...
                          <p class="text-gray-100 text-sm">
                            <span class="text-white font-bold"> Done : </span
                            >{{ invoices.done ? "Yes Done" : "No Undone" }}
                          </p>
                        </div>
                        <!-- More link -->
                        <a
                          @click="
                            $router.push(`/invoices-details/${invoices.id}`)
                          "
...
export default {
  setup() {
    ...
    return {
      ...
      closeDeleteModal: computed(() => invoiceStore.closeDeleteModal),
