    ...
    <div v-else class="p-4 max-w-[1300px] mt-[100px] mx-auto">
      ...
      >
        ...
        <span class="text-blue-800">
          There are currently no invoice item associated with this invoice. You
          can add a new invoice by clicking the button above
        </span>
      </div>
      <div v-else>
        <!-- Invoice Items Table -->
        ...
        >
          ...
          <form @submit.prevent="saveInvoiceItem">
            ...
            <div class="flex justify-end space-x-3 mt-4">
              ...
              <button
                type="submit"
                class="px-5 flex items-center py-2 text-white bg-blue-600 rounded-xl hover:bg-blue-700 transition"
              >
                <svg
                  v-if="loading"
                  class="animate-spin h-5 w-5 mr-2 text-white"
...
export default {
  setup() {
    ...
    return {
      ...
      closeDeleteModal: computed(() => invoiceItemsStore.closeDeleteModal),
